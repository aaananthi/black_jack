...
This project is to create a simple version of the very popular casino game, Blackjack (also known as 21). I am using Object Oriented Programming concepts to implement the logic for creating a deck, dealing cards, shuffling, betting and more. (The rules including splitting, doubling down and insurance are not implemented).
